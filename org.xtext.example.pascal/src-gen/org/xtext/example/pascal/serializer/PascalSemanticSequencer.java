...
public class PascalSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == PascalPackage.eINSTANCE)
			...
			case PascalPackage.ABSTRACTION_DECLARATION:
				if (rule == grammarAccess.getFunction_declarationRule()) {
					...
					sequence_function_declaration_procedure_declaration(context, (abstraction_declaration) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getProcedure_declarationRule()) {
					sequence_procedure_declaration(context, (abstraction_declaration) semanticObject); 
					return; 
				}
				else break;
	 ...
	 *
	 * Constraint:
	 *     ((heading=function_heading block=block) | (heading=procedure_heading block=block))
	 */
	protected void sequence_function_declaration_procedure_declaration(ISerializationContext context, abstraction_declaration semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_simple_type(ISerializationContext context, simple_type semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, PascalPackage.Literals.SIMPLE_TYPE__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PascalPackage.Literals.SIMPLE_TYPE__NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getSimple_typeAccess().getNameIDTerminalRuleCall_0(), semanticObject.getName());
		feeder.finish();
	}
