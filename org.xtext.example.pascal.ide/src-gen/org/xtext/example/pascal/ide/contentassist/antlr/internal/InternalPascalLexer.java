...
public class InternalPascalLexer extends Lexer {
    ...
    public final void mRULE_UNSIGNED_DIGIT_SEQUENCE() throws RecognitionException {
        try {
            // InternalPascal.g:469:39: ( ( RULE_DIGIT )+ )
            // InternalPascal.g:469:41: ( RULE_DIGIT )+
            {
            // InternalPascal.g:469:41: ( RULE_DIGIT )+
            int cnt4=0;
            loop4:
    ...
    public final void mRULE_DIGIT_SEQUENCE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:471:21: ( ( RULE_ADDITION_OP )? RULE_UNSIGNED_DIGIT_SEQUENCE )
            // InternalPascal.g:471:23: ( RULE_ADDITION_OP )? RULE_UNSIGNED_DIGIT_SEQUENCE
            {
            // InternalPascal.g:471:23: ( RULE_ADDITION_OP )?
            int alt5=2;
    ...
    public final void mRULE_DIGIT() throws RecognitionException {
        try {
            // InternalPascal.g:473:21: ( '0' .. '9' )
            // InternalPascal.g:473:23: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:475:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalPascal.g:475:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalPascal.g:475:11: ( '^' )?
            int alt6=2;
            ...
            // InternalPascal.g:475:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:477:10: ( ( '0' .. '9' )+ )
            // InternalPascal.g:477:12: ( '0' .. '9' )+
            {
            // InternalPascal.g:477:12: ( '0' .. '9' )+
            int cnt8=0;
            loop8:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:479:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalPascal.g:479:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalPascal.g:479:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalPascal.g:479:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalPascal.g:479:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop9:
                    do {
                        int alt9=3;
                    ...
                    break;
                case 2 :
                    // InternalPascal.g:479:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalPascal.g:479:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop10:
                    do {
                        int alt10=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:481:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalPascal.g:481:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalPascal.g:481:24: ( options {greedy=false; } : . )*
            loop12:
            do {
                int alt12=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:483:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalPascal.g:483:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalPascal.g:483:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop13:
            do {
                int alt13=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:485:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalPascal.g:485:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalPascal.g:485:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt16=0;
            loop16:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPascal.g:487:16: ( . )
            // InternalPascal.g:487:18: .
            {
            matchAny(); 
    ...
    static final String DFA17_eotS =
        "\1\uffff\1\25\1\uffff\1\30\2\uffff\1\35\3\uffff\2\23\1\40\1\23\1\uffff\2\23\3\uffff\1\25\14\uffff\1\40\2\uffff\4\25\1\51\1\uffff";
    static final String DFA17_eofS =
        "\52\uffff";
    static final String DFA17_minS =
        "\1\0\1\162\1\uffff\1\52\2\uffff\1\52\3\uffff\1\0\2\60\1\101\1\uffff\2\0\3\uffff\1\157\14\uffff\1\60\2\uffff\1\147\1\162\1\141\1\155\1\60\1\uffff";
    static final String DFA17_maxS =
        "\1\uffff\1\162\1\uffff\1\52\2\uffff\1\57\3\uffff\1\uffff\2\71\1\172\1\uffff\2\uffff\3\uffff\1\157\14\uffff\1\71\2\uffff\1\147\1\162\1\141\1\155\1\172\1\uffff";
    static final String DFA17_acceptS =
        "\2\uffff\1\2\1\uffff\1\4\1\5\1\uffff\3\7\4\uffff\1\13\2\uffff\1\6\1\20\1\21\1\uffff\1\13\1\2\1\10\1\3\1\4\1\5\1\16\1\17\1\6\1\7\1\11\1\12\1\uffff\1\15\1\20\5\uffff\1\1";
    static final String DFA17_specialS =
        "\1\2\11\uffff\1\0\4\uffff\1\1\1\3\31\uffff}>";
    static final String[] DFA17_transitionS = {
            "\11\23\2\22\2\23\1\22\22\23\1\22\1\23\1\17\4\23\1\20\1\3\1\4\1\21\1\13\1\5\1\13\1\23\1\6\12\14\1\23\1\2\1\10\1\7\1\11\2\23\32\16\3\23\1\15\1\16\1\23\17\16\1\1\12\16\1\12\uff84\23",
            "\1\24",
            "",
            "\1\27",
            "",
