...
public class PascalParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PascalGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSimple_statementAccess().getAlternatives_1(), "rule__Simple_statement__Alternatives_1");
			...
			builder.put(grammarAccess.getSimple_statementAccess().getGroup(), "rule__Simple_statement__Group__0");
			...
			builder.put(grammarAccess.getFactorAccess().getGroup_6(), "rule__Factor__Group_6__0");
			...
			builder.put(grammarAccess.getField_listAccess().getGroup_1(), "rule__Field_list__Group_1__0");
			...
			builder.put(grammarAccess.getSimple_statementAccess().getAssignmentAssignment_1_0(), "rule__Simple_statement__AssignmentAssignment_1_0");
			builder.put(grammarAccess.getSimple_statementAccess().getFunctionAssignment_1_1(), "rule__Simple_statement__FunctionAssignment_1_1");
			builder.put(grammarAccess.getSimple_statementAccess().getFunction_noargsAssignment_1_2(), "rule__Simple_statement__Function_noargsAssignment_1_2");
			...
			builder.put(grammarAccess.getFactorAccess().getBooleanAssignment_3(), "rule__Factor__BooleanAssignment_3");
			builder.put(grammarAccess.getFactorAccess().getBooleanAssignment_4(), "rule__Factor__BooleanAssignment_4");
			builder.put(grammarAccess.getFactorAccess().getFunctionAssignment_5(), "rule__Factor__FunctionAssignment_5");
			builder.put(grammarAccess.getFactorAccess().getExpressionAssignment_6_1(), "rule__Factor__ExpressionAssignment_6_1");
			builder.put(grammarAccess.getFactorAccess().getNotAssignment_7_1(), "rule__Factor__NotAssignment_7_1");
			builder.put(grammarAccess.getFactorAccess().getNilAssignment_8(), "rule__Factor__NilAssignment_8");
			...
			builder.put(grammarAccess.getFunction_procedure_declarationAccess().getFunctionsAssignment_0_0(), "rule__Function_procedure_declaration__FunctionsAssignment_0_0");
			builder.put(grammarAccess.getFunction_procedure_declarationAccess().getProceduresAssignment_0_1(), "rule__Function_procedure_declaration__ProceduresAssignment_0_1");
			...
			builder.put(grammarAccess.getSimple_typeAccess().getNameAssignment(), "rule__Simple_type__NameAssignment");
			builder.put(grammarAccess.getStructured_typeAccess().getTypeAssignment(), "rule__Structured_type__TypeAssignment");
			...
			builder.put(grammarAccess.getField_listAccess().getSectionsAssignment_0(), "rule__Field_list__SectionsAssignment_0");
			builder.put(grammarAccess.getField_listAccess().getSectionsAssignment_1_1(), "rule__Field_list__SectionsAssignment_1_1");
