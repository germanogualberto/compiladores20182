...
public class PascalParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PascalGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getExpressionAccess().getExpressionsAssignment(), "rule__Expression__ExpressionsAssignment");
			...
			builder.put(grammarAccess.getStructured_typeAccess().getRecordAssignment(), "rule__Structured_type__RecordAssignment");
