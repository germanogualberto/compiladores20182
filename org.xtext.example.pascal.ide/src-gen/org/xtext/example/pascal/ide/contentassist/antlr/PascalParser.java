...
public class PascalParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PascalGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getStrutured_typeAccess().getGroup(), "rule__Strutured_type__Group__0");
			...
			builder.put(grammarAccess.getStrutured_typeAccess().getPackedAssignment_0(), "rule__Strutured_type__PackedAssignment_0");
			builder.put(grammarAccess.getStrutured_typeAccess().getTypeAssignment_1(), "rule__Strutured_type__TypeAssignment_1");
			builder.put(grammarAccess.getUnpacked_strutured_typeAccess().getSetAssignment(), "rule__Unpacked_strutured_type__SetAssignment");
